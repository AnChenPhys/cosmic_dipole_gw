...
#for i in index:
    #if i<201:
    #i = int(i)
    filename = '/home/ansonchen/cosmic_dipole_gw/code/Fisher_sampler_O4_inc_dip/Fisher_samples_%d.dat'%i
...
for i in list(single_posterior.keys()): #range(len(single_posterior)):
    ...
    np.savetxt('posterior_H0_gridded_O4_inc_vcprior_icarogw_dip/posterior_H0_gridded_%d.txt'%i, [H0_array,single_posterior[i]])
...
plt.ylim(0)
plt.legend()
plt.savefig('/home/ansonchen/cosmic_dipole_gw/code/icarogw_O4_inc_vcprior_dip.png')
