...
for j in range(0,len(inj['injections_parameters']['m1d'])):
    ...
    np.savetxt('covariance_XG_golden_seed_1_g0p0005/BBH_cov_'+str(j)+'.txt', CovFish)
...
for j in range(0,len(inj['injections_parameters']['m1d'])):
    ...
    np.savetxt('covariance_XG_golden_seed_1_g0p0005/NSBH_cov_'+str(j)+'.txt', CovFish)
...
for j in range(0,len(inj['injections_parameters']['m1d'])):
    ...
    np.savetxt('covariance_XG_golden_seed_1_g0p0005/BNS_cov_'+str(j)+'.txt', CovFish)
