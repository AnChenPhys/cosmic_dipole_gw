...
det_l1 = {"name":"a_sharp","lon":-90.8,"lat":30.6,"rot":197.7,"shape":90,"abv":'L1'} #L1
...
for j in range(0,len(inj['injections_parameters']['m1d'])):
    ...
    np.savetxt('covariance_ET_A#_golden_seed_1_g0p001/BBH_cov_'+str(j)+'.txt', CovFish)
...
for j in range(0,len(inj['injections_parameters']['m1d'])):
    ...
    np.savetxt('covariance_ET_A#_golden_seed_1_g0p001/NSBH_cov_'+str(j)+'.txt', CovFish)
...
for j in range(0,len(inj['injections_parameters']['m1d'])):
    ...
    np.savetxt('covariance_ET_A#_golden_seed_1_g0p001/BNS_cov_'+str(j)+'.txt', CovFish)
